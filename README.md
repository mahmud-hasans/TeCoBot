...
Code repository for **TeCoBot**, a tensegrity-based modular continuum robot with compliant body deformation, claw-based docking, locomotion, manipulation, loco-manipulation, and autonomous visual docking experiments.
